...
async def login_for_access_token(
    ...
    """This function is a route handler for the /login endpoint. It authenticates the user and returns a new access token and refresh token."""
...
async def read_users_me(
    ...
    """This function is a route handler for the /users/me/ endpoint. It returns the current active user."""
    return current_user
...
async def read_own_items(
    ...
    """This function is a route handler for the /users/me/items/ endpoint. It returns the current active user's items."""
